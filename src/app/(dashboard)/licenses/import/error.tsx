...
export default function ImportError({
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Import Licenses</h1>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-red-200 dark:border-red-500/20 p-8 text-center shadow-sm">
        ...
        <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Unable to load import page</h2>
