  ...
  return (
    <div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-red-200 dark:border-red-500/20 p-8 text-center shadow-sm">
        ...
        <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Unable to load licenses</h2>
        <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
          An error occurred while loading your license data. Please try again.
        </p>
        <button
          type="button"
          onClick={reset}
